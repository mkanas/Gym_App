...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#ffffff] w-full fixed left-0 top-0  z-10  transition-all ease-in duration-300 ">
      <div className="max-w-[1440px] mx-auto flex justify-between items-center p-[14px] text-white">
        ...
        <div className="block md:hidden   ">
          ...
          >
            ...
            <div className=" flex font-semibold justify-start  py-3 ">
              <button className="uppercase rounded-3xl px-2 text-black bg-white">
                Membership
              </button>
